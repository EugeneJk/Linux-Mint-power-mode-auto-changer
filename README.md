...
```
git clone https://gitflic.ru/project/shadyjk/linux-mint-auto-power-mode-changer.git
cd linux-mint-auto-power-mode-changer
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/shadyjk/linux-mint-auto-power-mode-changer.git
git clone
